  ...
  <div class="input__container">
    <div class="input__wrapper">
      <input
        :id="id"
        class="input"
        :class="[errorMessage && !isFocus ? 'input__error' : '', type==='search' ? 'input__search' : '', heightClasses]"
      ...
      <label
        :class="['input__label', type==='search' && value ? 'input__label_none' : '']"
        :for="id"
      >
        {{ label || placeholder }}
      </label>
...
.input__search:focus,
.input__search:not(:placeholder-shown) {
  padding: 22px 20px;
}
...
.input:focus.input__search ~ .input__label {
  display: none;
}
.input__label_none {
  display: none;
